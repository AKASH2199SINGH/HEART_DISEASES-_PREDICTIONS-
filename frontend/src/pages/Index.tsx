          ...
          <div className="text-center text-primary-foreground max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              ...
              <div className="flex flex-col items-center p-6 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
                ...
                <p className="text-sm text-primary-foreground/80">Your health data is processed securely</p>
              </div>
              <div className="flex flex-col items-center p-6 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
                <TrendingUp className="h-8 w-8 mb-3" />
                <h3 className="font-semibold mb-2">ML Powered</h3>
                <p className="text-sm text-primary-foreground/80">Advanced algorithms for accurate prediction</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Fill in your cardiac parameters below to receive a comprehensive risk assessment. 
          ...
          <div className="mt-12 p-6 bg-muted/50 rounded-lg border border-border/50">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                and never disregard professional medical advice based on information from this tool.
              </p>
            </div>
          </div>
        </div>
